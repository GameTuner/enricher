...
object Dependencies {
  ...
  object V {
    ...
    val postgresGcp      = "1.8.0"
    val openConcensus    = "0.31.1"
  ...
  object Libraries {
    ...
    val postgresGcp      = "com.google.cloud.sql"       %  "postgres-socket-factory"       % V.postgresGcp
    val openConcensusApi = "io.opencensus"              %  "opencensus-api"                               % V.openConcensus
    val openConcensusImpl      = "io.opencensus"              %  "opencensus-impl"                        % V.openConcensus
    val openConcensusExporter  = "io.opencensus"              %  "opencensus-exporter-stats-stackdriver"  % V.openConcensus
    ...
    val gcpCore          = "com.google.cloud"                 %  "google-cloud-core"                 % V.gcpSdk
