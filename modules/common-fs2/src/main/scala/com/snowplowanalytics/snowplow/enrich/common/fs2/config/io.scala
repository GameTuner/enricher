...
object io {
  ...
  case class MetadataService(appIdConfigsEndpoint: String, cacheRefreshIntervalSeconds: Int)

  object MetadataService {
    implicit val metadataServiceDecoder: Decoder[MetadataService] =
      deriveConfiguredDecoder[MetadataService]
    implicit val metadataServiceEncoder: Encoder[MetadataService] =
      deriveConfiguredEncoder[MetadataService]
  }
