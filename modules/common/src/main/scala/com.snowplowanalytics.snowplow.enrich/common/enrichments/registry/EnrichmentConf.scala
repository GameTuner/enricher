...
import com.snowplowanalytics.snowplow.enrich.common.enrichments.registry.apirequest.{ApiRequestEnrichment, CreateApiRequestEnrichment, HttpApi}
...
object EnrichmentConf {
  ...
  final case class UniqueIdResolverConf(
    schemaKey: SchemaKey,
    username: String,
    password: String,
    database: String,
    ...
    def enrichment[F[_]: Functor: CreateUniqueIdWrapper](blocker: BlockerF[F]): F[UniqueIdEnrichment[F]] =
      UniqueIdEnrichment[F](this, blocker)
  }
}
